...
const uint8_t Em_App_hash[] = {148, 134, 171, 110, 181, 54, 112, 156, 24, 122, 62, 113, 224, 113, 193, 128, 13, 0, ((sizeof(struct{uint8_t f1; uint16_t f2;}) - sizeof(uint16_t)) << 4) | (sizeof(struct{uint8_t f1; uint32_t f2;}) - sizeof(uint32_t))};

const uint8_t Em_App_build[] = {105, 249, 254, 99, 69, 1, 0, 0};
